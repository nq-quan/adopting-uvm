...
def start_snipping(line):
    return line.find("\\strokec3 {\\listtext\t1.\t}") == 0
...
def pickle_codes(codes, pickleFile_name):
    ...
    with open(pickleFile_name, 'w') as file:
...
if __name__ == '__main__':
    ...
    Log = utils.get_logger('log', logging.DEBUG)
    ...
    try:
       ...
       Log.critical("usage: extractor.py v1.0/TXT.rtfd/TXT.rtf")
       sys.exit(1)
